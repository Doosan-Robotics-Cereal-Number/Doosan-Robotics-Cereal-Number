...
#   """
    ...
    def chat(self, user_message):
        ...
        Returns:
            tuple: (응답 텍스트, 주문 정보 dict or None)
        """
        # 대화 히스토리에 추가
        ...
        # JSON 추출 시도
        order_info = self._extract_order_info(assistant_message)
        ...
        return clean_message, order_info
    ...
    def _extract_order_info(self, message):
        ...
        Returns:
            dict or None: 주문 정보 (complete가 true일 때만)
        """
        try:
            # JSON 부분 찾기
            start = message.find('{')
...
if __name__ == "__main__":
    ...
    for user_msg in test_conversation:
        ...
        response, order = assistant.chat(user_msg)
        print(f"🤖 {response}")
