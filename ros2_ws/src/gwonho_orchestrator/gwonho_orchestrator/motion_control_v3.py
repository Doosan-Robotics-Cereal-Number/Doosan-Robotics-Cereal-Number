...
def main():
    ...
    def _late_init():
        ...
        def step_give_cereal_b(params, gh, check_cancel):
            ...
            x_give_cereal_b4 = posx(0, 0, -50, 0, 0, 0)    # tool 기준
            x_give_cereal_b5 = posx(0, 0, 68, 0, 0, 0)    # tool 기준
            x_give_cereal_b6 = posx(0, 0, 0, 0, 0, 100)   # tool 기준
            x_give_cereal_b7 = posx(0, 0, 0, 0, 0, -120)  # tool 기준
            q_give_cereal_b8 = posj(184.86, -82.91, -7.12, 270, -94.91, -178)
            ...
            fb(gh, 0.55, "give_cereal_b4"); movel_blocking(x_give_cereal_b4, 200*sp, 200*sp, ref=DR_TOOL); check_cancel()

            check_cancel()
            fb(gh, 0.60, "release"); gripper.fast_move(0); wait(0.5); check_cancel()
            fb(gh, 0.65, "give_cereal_b5"); movel_blocking(x_give_cereal_b5, 200*sp, 200*sp, ref=DR_TOOL); check_cancel()
