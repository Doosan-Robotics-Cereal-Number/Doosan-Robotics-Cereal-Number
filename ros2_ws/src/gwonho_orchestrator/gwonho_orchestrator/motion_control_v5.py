...
def main():
    ...
    def _late_init():
        ...
        stop_cli = node.create_client(MoveStop, f'/{ROBOT_ID}/motion/move_stop')
        ...
        def quick_stop():
            """로봇 움직임 즉시 정지"""
            if not stop_cli.wait_for_service(timeout_sec=5.0):
        ...
        def step_give_cereal_a(params, gh, check_cancel):
            ...
            x_give_cereal_a12 = posx(0, 0, 0, 0, 0, -100) # tool 기준
            ...
            if not wait_for_contact(axis=1, min_force=7.3, max_force=12.0, ref=0, timeout_s=15.0):
        ...
        def step_give_cereal_b(params, gh, check_cancel):
            ...
            x_give_cereal_b3 = posx(737, -110, 269, 90, -90, 90)
            q_give_cereal_b4 = posj(189.1, -77.9, -14.52, 270.71, -97.9, -178.54)    
            q_give_cereal_b5 = posj(183.41, -79.43, -10.56, 270.71, -93.29, -178.54)    
            x_give_cereal_b6 = posx(0, 0, 0, 0, 0, 100)   # tool 기준
            x_give_cereal_b7 = posx(0, 0, 0, 0, 0, -100)  # tool 기준
            ...
            fb(gh, 0.55, "give_cereal_b4"); movej_blocking(q_give_cereal_b4, 200*sp, 200*sp); check_cancel()

            check_cancel()
            fb(gh, 0.60, "release"); gripper.fast_move(0); wait(0.5); check_cancel()
            fb(gh, 0.65, "give_cereal_b5"); movej_blocking(q_give_cereal_b5, 200*sp, 200*sp); check_cancel()
            fb(gh, 0.70, "grab"); gripper.move(740); wait(0.5); check_cancel()
        ...
        def step_move_pickup_1(params, gh, check_cancel):
            ...
            x_move_pickup_1_2 = posx(700, 200, 60, 180, -90, 90)
            x_move_pickup_1_3 = posx(700, 200, 300, 180, -90, 90)
            x_move_pickup_1_4 = posx(500, 200, 300, 180, -90, 90)

            fb(gh, 0.1, "move_pickup_1_1"); movel_blocking(x_move_pickup_1_1, 200*sp, 200*sp); check_cancel()
            fb(gh, 0.3, "move_pickup_1_2"); movel_blocking(x_move_pickup_1_2, 100*sp, 100*sp); check_cancel()
        ...
        def step_move_pickup_2(params, gh, check_cancel):
            ...
            x_move_pickup_2_2 = posx(700, 360, 60, 180, -90, 90)
            ...
            fb(gh, 0.3, "move_pickup_2_2"); movel_blocking(x_move_pickup_2_2, 100*sp, 100*sp); check_cancel()
            fb(gh, 0.5, "release"); gripper.fast_move(0); wait(0.5); check_cancel()
        ...
        def step_grab_personal_cup(params, gh, check_cancel): 
            ...
            try:
                ...
                ox,oy,oz = current_pos[0], current_pos[1], current_pos[2]
                ...
                q_move_personal_cup = posj(181.24, -35.24, -93.8, -88.52, 88.88, 141.07)
                ...
                q_move_personal_cup = posj(131.51, -50.21, -126.62, -139.63, 90.62, 90.02)
                movej_blocking(q_move_personal_cup, 50*sp, 50*sp)  # ✅ blocking
                check_cancel()
                ...
                x_personal_go_to_home1 = posx(201, -58, 150, 90, 90, -90)
                movel_blocking(x_personal_go_to_home1, 200*sp, 200*sp)
                check_cancel()
                
                fb(gh, 0.70, "waypoint2")
                x_personal_go_to_home2 = posx(201, -200, 150, 90, 90, -90)
